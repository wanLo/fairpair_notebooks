...
class RankRecovery:
    ...
    def __init__(self, G:FairPairGraph, class_attr='minority', weight_attr='weight'):
        '''
    ...
    def apply(self, rank_using=rankCentrality, **kwargs) -> dict:
        '''
    ...
    def _print_with_score(self, ranking:dict):
        ...
        for node, rank_score in ranking.items():
            print(node, self.G.nodes[node]['score'], rank_score)