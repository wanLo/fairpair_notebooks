...
def get_accuracy(trial:int, N=500, Nm=100):
    ...
    for j in range(10):
        ...
        if len(other_nodes) == 0:
            ...
            accuracy.append((trial, j*10, weighted_tau(H, ranking, H.majority), 'Majority'))
            accuracy.append((trial, j*10, weighted_tau(H, ranking, H.minority), 'Minority'))
    return accuracy
