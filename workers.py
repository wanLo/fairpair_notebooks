...
def get_accuracy(trial:int, N=500, Nm=100):
    ...
    for j in range(100):
        sampler.apply(iter=1, k=1) #min_prob=0.1
        ...
        if len(other_nodes) == 0:
            ...
            accuracy.append((trial, j, weighted_tau(H, ranking, H.majority), 'Majority'))
            accuracy.append((trial, j, weighted_tau(H, ranking, H.minority), 'Minority'))
    return accuracy
